<template>
  <div
    class="w-screen max-w-screen h-screen max-h-screen overflow-clip relative"
  >
    <div id="stars"></div>
    <div id="stars2"></div>
    <div id="stars3"></div>
    <div class="hover w-full h-full absolute left-0 bottom-0"></div>
  </div>
</template>
...
.hover {
  transition: all 0.3s;
  background: linear-gradient(0deg, #010814 0%, rgba(1, 8, 20, 0) 95.79%);
}
